 ...
 * @param {{specifier: URL | string, base?: URL, readFileSync: readFileSync}} options
 * @returns {PackageConfig}
 */
export function read(jsonPath, {base, specifier, readFileSync}) {
...
/**
 * @param {{resolved: URL | string, readFileSync: readFileSync}} arguments_
 * @returns {PackageConfig}
 */
...
export function getPackageType({url, readFileSync}) {
  ...
  return getPackageScopeConfig({resolved: url, readFileSync}).type
}
